          ...
          <div className="flex items-center lg:order-2">
            {!isLoggedIn ? (
              <>
                <Link
                  to={"/login"}
                  className="text-gray-800 dark:text-white hover:bg-gray-50 focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-4 lg:px-5 py-2 lg:py-2.5 mr-2 dark:hover:bg-gray-700 focus:outline-none dark:focus:ring-gray-800 border-2 border-solid border-transparent hover:border-blue-600 dark:hover:border-gray-700"
                >
                  Log in
                </Link>
                <Link
                ...
                (item) =>
                  item.isActive && (
                    <li key={item.name}>
                      <Link
                        to={item.link}
                        className="block py-2 pr-4 pl-3 dark:text-gray-400 dark:hover:text-white  text-black hover:text-blue-600 "
                      >
                        {item.name}
                      </Link>
                    </li>
